...
public interface DictionaryInterface<K,V> {
     ...
     * @return  Either null if the new entry was added to the dictionary or the value that was associated with the key if that value was replaced.
     */
     ...
     * @return  Either the value that was associated with the search key or null if no such objects exist.
     */
    public V remove(K key);

    /**
     * Retrieves from this dictionary with the value associated with a given search key.
